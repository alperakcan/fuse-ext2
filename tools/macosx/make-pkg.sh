...
${INSTALL_C} -m 755 ${BUILD_FOLDER}/e2fsprogs-1.41.5/misc/fuse-ext2.e2label ${DISTRIBUTION_FOLDER}/usr/local/bin/e2label
${INSTALL_C} -m 755 ${BUILD_FOLDER}/e2fsprogs-1.41.5/misc/fuse-ext2.mke2fs ${DISTRIBUTION_FOLDER}/usr/local/bin/mke2fs
